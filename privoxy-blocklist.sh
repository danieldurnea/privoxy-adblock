...
URLS=("https://raw.githubusercontent.com/mkb2091/blockconvert/master/output/domains.txt" "https://raw.githubusercontent.com/notracking/hosts-blocklists/master/dnscrypt-proxy/dnscrypt-proxy.blacklist.txt")
